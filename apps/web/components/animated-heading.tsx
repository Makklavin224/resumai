 ...
 * pulsing "?" attaches to the eyebrow — the eyebrow stays a block-level
 * paragraph so it always sits *above* the h2, not next to it.
 */
export function AnimatedHeading({ eyebrow, children, className, withQuestion }: Props) {
  return (
    ...
    >
      ...
      <h2 className="font-display mt-3 block text-3xl font-bold leading-tight sm:text-4xl">
        {children}
      </h2>
    </motion.div>
  );
